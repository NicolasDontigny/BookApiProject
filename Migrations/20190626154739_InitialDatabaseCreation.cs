    ...
    public partial class InitialDatabaseCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCategoriess", x => new { x.BookId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_BookCategoriess_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCategoriess_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCategoriess_CategoryId",
